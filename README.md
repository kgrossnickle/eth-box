...
Win 10 --
Visual Studio 2019 --
 -- VS C++ and WinRT packages ( should ask if you want to install these after git cloning) -- Xbox Series S, Series X or Xbox One. Might work with others though idk
